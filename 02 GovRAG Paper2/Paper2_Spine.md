...
*Text twin of Paper2_Spine.docx v2.4, generated 2026-07-25 for git timestamping under the
...
*v2.4 — S40 + S41 + S42(a–e) applied on Vivek’s approval (2026-07-27), closing the Numbers Verification Ledger pass: F3 granularity clause + T1 root-cause wording (S40); leakage judge-labelled, primary 23.4/15.6/1.6–7.8% (S41); H1 primary Δ .074, HAGRID .139, answerable-stratum label (S42a); leniency direction confirmed already correct in spine (S42b, no change); G2-tier net flip +1.5% (S42c); M4 numerator 3,714 (S42d); halluc-on-answered judge-labelled, primary 0–0.7% (S42e). Metric formulas locked in Manuscript_Dictionary; ledger: 5_Drafts\Numbers_Verification_Ledger.md.*
...
Citations resolve to archived evidence for 97.7–100% of governed answers — resolving at two granularities: individual chunk ids at G1, and for ~38% of cited G2+ answers the designed block-level [CHNK_PRIMARY] tag whose contents are enumerated in the Q5 decision log; the Q5 decision log — every admit/reject with its rule — is present for governed decisions by construction, refusals included. Concretely: from the logs alone, an auditor can take any governed answer and reconstruct which chunks were retrieved, which the Reference Monitor admitted or dropped and under which manifest rule, and which admitted evidence the answer cites — without re-running the system. The trail is nearly free: at G1, coverage stays at 92.5 / 77.9 / 58.7% with full provenance, decision logs, and ceiling faithfulness — auditability almost without the coverage price. This is the only hypothesis supported without qualification on every corpus.

> **Numbers:** resolvable citations: 97.7–99.9% (DelucionQA; the remainder are answers synthesised from admitted symbolic triplets, for which the citation vocabulary offers no tag — no cited identifier in the study failed to resolve) / 100.0% (206/206, HAGRID) / 100.0% (238/238, ExpertQA); G1 coverage 92.5 / 77.9 / 58.7%
>
...
> **Numbers:** M4 ontology-aligned share 98.2% (3,714/3,781, D) / 47.2% (332/703, E) / 25.8% (77/298, H) ↔ slope / band / cliff
>
...
> **Numbers:** κ=0.681 (graded pairs; 0.863 incl. refusals); flips 504 vs 190; net lenient flips +17.9 / +14.4 / +1.5 / +3.2 / −0.3% (G0, G1, G2 tier, G3, G4); Δacc(G1−naive): −.018 \[−.050,+.014\] initial vs −.065 \[−.090,−.041\] primary
>
...
|-------|---------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| H1    | Quality parity on the answerable stratum: governed vs naive within ±0.05 equivalence bound                                      | NOT SUPPORTED under the primary judge (any corpus); borderline under the initial judge on run 1 only                        | Point Δ (per-arm answerable-stratum accuracy, refusals as misses): .034 (run 1, initial) / .074 (run 1, primary) / .139 (HAGRID) / .133 (ExpertQA). Paired bootstrap (identical resamples, B=10,000, seed 20260720, run 1): −.018 \[−.050,+.014\] initial / −.065 \[−.090,−.041\] primary. Reading: near-parity only in-ontology, within a judge-dependent 3–7-pt band; off-ontology the G1 cost is real (~13 pts) (F7) |
