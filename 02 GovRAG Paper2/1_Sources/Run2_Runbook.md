> **SNAPSHOT 2026-07-22** — read-only copy for paper writing. CANONICAL: OneDrive Paper2\2_Design\Run2_Runbook.md (git mirror: repo docs\ where present) — edit the canonical, then re-snapshot. See Source_Register.docx.
...
- ☐ `python E3_Parallel_Evaluation.py --judge-model gemini-3.1-pro-preview --workers 12 --out-prefix E3_run2_expertqa`
